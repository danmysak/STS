...
resourcestring
  ...
  SMsgDlgNo = '&Ні';
  SMsgDlgOK = 'OK';
  SMsgDlgCancel = 'Скасувати';
  SMsgDlgHelp = '&Довідка';
  SMsgDlgHelpNone = 'Довідка недоступна';
  SMsgDlgHelpHelp = 'Довідка';
  SMsgDlgAbort = '&Перервати';
  SMsgDlgRetry = '&Ще раз';
  SMsgDlgIgnore = 'П&ропустити';
  SMsgDlgAll = '&Всі';
  SMsgDlgNoToAll = 'Н&і для всіх';
  SMsgDlgYesToAll = 'Так для &всіх';
